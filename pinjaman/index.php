...
// Fetch all pinjaman data
$pinjamanQuery = "SELECT * FROM pinjaman";
...
<body>
    ...
    <div class="dashboard">
        ...
        <div class="main-content">
            ...
            <!-- Search Input -->
            <div class="form-group pencari">
                <br><br>
                <label for="search">Cari Nama Anggota:</label>
                <input type="text" class="form-control" id="search" placeholder="Masukkan nama anggota...">
            </div>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th>Jumlah Pinjam</th>
                            <th>Lama Pinjam (bln)</th>
                            <th>Bunga (%)</th>
                            <th>Angsuran</th>
                            <th>Status</th>
                            <th class="mati">Action</th>
                        </tr>
                    </thead>
                    <tbody id="pinjamanTableBody">
                        <?php foreach ($pinjamanList as $pinjaman) : ?>
                            <tr>
                                ...
                                <td><a href="detail_pinjaman.php?id=<?= $pinjaman['id_anggota']; ?>"><?= $pinjaman['nama_anggota']; ?></a></td>
                                ...
                                <td><?= number_format($pinjaman['angsuran'], 2, '.', ''); ?></td>
                                <td><?= ($pinjaman['lunas'] == 1) ? 'Lunas' : 'Belum Lunas' ?></td>
                                <td class="mati">
                                    <a href="edit_pinjaman.php?id=<?= $pinjaman['id_pinjaman'] ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <form method="post" style="display:inline;">
                                        <input type="hidden" name="delete_pinjaman" value="<?= $pinjaman['id_pinjaman']; ?>">
