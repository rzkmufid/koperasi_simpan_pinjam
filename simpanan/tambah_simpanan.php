    ...
    <div class="dashboard">
        ...
        <div class="main-content">
            ...
            <form action="crud_simpanan.php" method="post">
                <input type="hidden" name="aksi" value="tambah_simpanan">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="id_anggota" id="id_anggota" value="<?= $_GET['id'] ?>" required readonly>
                </div>
                <div class="form-group">
                    <label for="kode_transaksi">Kode Transaksi:</label>
                    <input type="text" class="form-control" id="kode_transaksi" name="kode_transaksi" value="SMP" required>
                </div>
                <div class="form-group">
                    <label for="tanggal_simpan">Tanggal Simpan:</label>
                    <input type="date" class="form-control" id="tanggal_simpan" name="tanggal_simpan" required readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="wajib" name="wajib" required>
                </div>
                <div class="form-group">
                    <label for="sukarela">Sukarela:</label>
                    <input type="text" class="form-control" id="sukarela" name="sukarela" required>
                </div>
